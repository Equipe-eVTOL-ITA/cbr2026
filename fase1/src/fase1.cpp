...
// Estados desta missao. Crie em include/fase1/states/ e inclua aqui.
// #include "fase1/states/meu_estado.hpp"

/**
 * @brief Maquina de estados da missao fase1.
 *
...
/**
 * @brief No ROS 2 que executa a FSM da missao fase1.
 *
...
public:
    explicit Fase1Node(std::shared_ptr<Drone> drone)
        : rclcpp::Node("fase1_node"), drone_(drone) {
        ...
        fsm_ = std::make_unique<Fase1FSM>(drone_, params);
        ...
        //     "minha_deteccao", 10,
        //     std::bind(&Fase1Node::cv_callback, this, std::placeholders::_1));

        RCLCPP_INFO(this->get_logger(), "FSM da missao fase1 iniciada");
    }
...
int main(int argc, const char *argv[]) {
    ...
    auto mission_node = std::make_shared<Fase1Node>(drone);
